...
const { createCanvas, updateCanvas, loadCanvas, shareCanvas, leaveCanvas, unshareCanvas, deleteCanvas, getUserCanvases } = require("../controllers/canvasController");
...
router.put("/leave/:id", authMiddleware, leaveCanvas);
